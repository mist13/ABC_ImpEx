...
Die Programme abc2xml bzw. xml2abc werden benötigt.</translation>
 ...
 ==========
        ...
        abc2xml.py bzw xml2abc.py in diesen Pluginordner kopieren:
        %1

        Sollten die Dateien schon woanders installiert sein,
        diesen Pfad in die Ini-Datei im gleichen Ordner eintragen.

        Unter Windows muss Python installiert sein und der Pfad
        zu Python in der Umgebungsvariable PATH inkludiert sein.
...
or enter path into abc_ImpEx.ini.</source>
        <translation>Diese Funktion benötigt abc2xml.
Datei in den abc_ImpEx-Ordner kopieren
...
Copy file into abc_ImpEx folder
or enter path into abc_ImpEx.ini.</source>
        <translation>Diese Funktion benötigt xml2abc.
Datei in den abc_ImpEx-Ordner kopieren
oder den Pfad in die abc_ImpEx.ini eintragen.</translation>
    </message>
    <message>
 ...
 ======
            ...
            1. ABC einfügen oder eine Datei über die Taste &apos;Öffnen&apos; wählen.

            2. ABC nach Wunsch bearbeiten bzw. Text markieren.

            3. Als Partitur importieren mittels &apos;Import&apos;.
            
 EXPORT
 ======

            1. Zum Übersetzen der aktiven Partitur &apos;Export&apos; drücken.

            2. ABC nach Wunsch bearbeiten bzw. Text markieren.

            3. Mit der Taste &apos;Speichern&apos; in einer Datei speichern.</translation>
    </message>
</context>
</TS>
